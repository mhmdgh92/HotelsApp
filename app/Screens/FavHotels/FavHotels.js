...
class FavHotels extends React.Component{

    render() {
      return(
        <View>
          <View style={{height:ScreenHeight*0.875,ScreenWidth:ScreenWidth}}>
            
          </View>
          <MyFooter SelectedTab={2} Navigator={this.props.navigation}/>
        </View>
      )
    }
}
